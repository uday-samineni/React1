...
const DashCardPub =({content,...props})=>{
    ...
    return(
        <Card style={{width:widthPercentageToDP(90.667),height:heightPercentageToDP(13.547),backgroundColor:"#7FB838",borderRadius:10}}>
            <CardItem style={{backgroundColor:"#F2782B",borderRadius:10}}>
                <Body style={{backgroundColor:"#F2782B"}}>
                    <Text style={{fontSize:18,color:"white",fontWeight:"bold"}}>Publishers</Text>
