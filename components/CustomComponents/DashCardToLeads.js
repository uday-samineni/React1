...
const DashCardToLeads =({content,...props})=>{
    ...
    return(
        <Card style={{width:widthPercentageToDP(90.667),height:heightPercentageToDP(13.547),backgroundColor:"#6D07C3",borderRadius:10}}>
            <CardItem style={{backgroundColor:"#6D07C3",borderRadius:10}}>
                <Body style={{backgroundColor:"#6D07C3"}}>
                    <Text style={{fontSize:18,color:"white",fontWeight:"bold"}}>Total Leads</Text>
...
export default DashCardToLeads