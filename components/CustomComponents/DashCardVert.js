...
const DashCardVert =({content,...props})=>{
    ...
    return(
        <Card style={{width:widthPercentageToDP(90.667),height:heightPercentageToDP(13.547),backgroundColor:"#7062F5",borderRadius:10}}>
            <CardItem style={{backgroundColor:"#7062F5",borderRadius:10}}>
                <Body style={{backgroundColor:"#7062F5"}}>
                    <Text style={{fontSize:18,color:"white",fontWeight:"bold"}}>Average Verticals</Text>
