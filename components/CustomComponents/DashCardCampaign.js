...
const DashCardCampaign =({content,...props})=>{
    ...
    return(
        <Card style={{width:widthPercentageToDP(90.667),height:heightPercentageToDP(13.547),backgroundColor:"#F53B6D",borderRadius:10}}>
            <CardItem style={{backgroundColor:"#7FB838",borderRadius:10}}>
                <Body style={{backgroundColor:"#7FB838"}}>
                    <Text style={{fontSize:18,color:"white",fontWeight:"bold"}}>Campaigns</Text>
...
export default DashCardCampaign