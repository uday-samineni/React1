...
const DashCardLeads =({content,...props})=>{
    ...
    return(
        <Card style={{width:widthPercentageToDP(90.667),height:heightPercentageToDP(13.547),backgroundColor:"#6D07C3",borderRadius:10}}>
            <CardItem style={{backgroundColor:"#F53B6D",borderRadius:10}}>
                <Body style={{backgroundColor:"#F53B6D"}}>
                    <Text style={{fontSize:18,color:"white",fontWeight:"bold"}}>Average Leads</Text>
                    ...
                    <View style={{flexDirection:"row"}}>
                        <TouchableOpacity onPress={()=>{
                            ...
                            <Text style={firstStyle1[0]}>Weekly</Text>
                        </TouchableOpacity>
                        ...
                        style={firstStyle[1]}>
                            <Text style={firstStyle1[1]}>Monthly</Text>
                        </TouchableOpacity>
                        <Text style={{width:widthPercentageToDP(4)}}></Text>
                        <TouchableOpacity
                            onPress={()=>{
                        ...
                        style={firstStyle[2]}>
                            <Text style={firstStyle1[2]}>Yearly</Text>
                        </TouchableOpacity>
                    </View>
                    <Text style={{height:heightPercentageToDP(2)}}></Text>
